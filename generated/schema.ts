...
export class CommentAction extends Entity {
  ...
  get reportAction(): Bytes {
    let value = this.get("reportAction");
    if (!value || value.kind == ValueKind.NULL) {
      throw new Error("Cannot return null for a required field.");
    } else {
      return value.toBytes();
  ...
  set reportAction(value: Bytes) {
    this.set("reportAction", Value.fromBytes(value));
  }
}
...
export class DiceRolled extends Entity {
  ...
  get playerAction(): PlayerActionLoader {
    return new PlayerActionLoader(
      "DiceRolled",
      this.get("id")!
        .toBytes()
        .toHexString(),
...
export class PlayerAction extends Entity {
  ...
  get reportActions(): ReportActionLoader {
    return new ReportActionLoader(
      "PlayerAction",
      this.get("id")!
        .toBytes()
        .toHexString(),
  ...
  get diceRolls(): DiceRolledLoader {
    return new DiceRolledLoader(
      "PlayerAction",
      this.get("id")!
        .toBytes()
        .toHexString(),
...
export class ReportAction extends Entity {
  ...
  get commentActions(): CommentActionLoader {
    return new CommentActionLoader(
      "ReportAction",
      this.get("id")!
        .toBytes()
        .toHexString(),
...
export class PlayerActionLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): PlayerAction[] {
    ...
    return changetype<PlayerAction[]>(value);
  }
}

export class ReportActionLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): ReportAction[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<ReportAction[]>(value);
  }
}

export class DiceRolledLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): DiceRolled[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<DiceRolled[]>(value);
  }
}

export class CommentActionLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
  ...
  load(): CommentAction[] {
    let value = store.loadRelated(this._entity, this._id, this._field);
    return changetype<CommentAction[]>(value);
  }
}
